...
@section('content')
    <style>
        .card-color-custom:hover {
            box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px !important;
        }

        .card-color-custom form input {
            cursor: pointer !important;
        }
    </style>
    <!-- Content Wrapper -->
    <div class="d-flex flex-column card-container-colors">
        <div class="py-5">
            <h4 class="text-white">Culoare Departamente</h4>
            <div class="row mt-3">
                @foreach ($departments as $department)
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card card-color-custom shadow h-100 py-2"
