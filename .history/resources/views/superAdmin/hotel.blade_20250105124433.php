                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.hotel.create-user', ['id' => $hotelSelected->id]) }}" method="POST">
                            ...
                            <div class="mb-3 col-md-5 col-12 p-0">
                                ...
                                <input type="<input type="password" class="form-control" id="passwordInput" placeholder="Introduceți parola">" class="form-control @error('password') is-invalid @enderror"
