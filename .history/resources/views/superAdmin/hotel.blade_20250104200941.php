    ...
    <div id="content-wrapper border-0" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="mt-5 card shadow mb-4" id="formular-angajati">
                ...
                @foreach ($departments as $department)
                    <div class="mb-4 p-4 border-bottom border-3 border-success">
                        <h3 class="d-flex justify-content-between align-items-center">
                            Departament: <b>{{ $department->name }}</b>
                            <a href="#" class="btn btn-link d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#department-{{ $department->id }}" aria-expanded="false" aria-controls="department-{{ $department->id }}">
                                <span class="me-2">Vezi Angajați</span>
                        ...
                        <div class="collapse" id="department-{{ $department->id }}">
                            ...
                            @if ($employees->where('department_id', $department->id)->where('role_id', 3)->isEmpty())
                                <p class="text-center">Nu sunt șefi de departament înregistrați pentru acest departament.
                                </p>
                            @endif
