                        ...
                        <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text mb-4">Near Afionas village, on the west coast of Corfu island.
                                        The two beaches form two unique bays. The turquoise color of the sea contrasts
                                        to the high green hills surrounding it.</p>
                                    <a href="#" class="btn btn-primary mt-auto align-self-start">Book now</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text mb-4">Located just outside the City Gate of Valletta, Malta. It
                                        consists of three bronze Tritons holding up a large basin, balanced on a
