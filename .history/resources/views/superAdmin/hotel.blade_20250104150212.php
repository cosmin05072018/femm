                        ...
                        <div class="container mt-5">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control w-50 w-100" id="name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control w-50 w-100" id="phone"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control w-50 w-100" id="email"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select w-50 w-100" id="role" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select w-50 w-100" id="department" required>
