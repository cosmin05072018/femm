            ...
            <div class="mt-5 card shadow mb-4" id="formular-angajati">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        @if ($employees->where('role_id', 3)->isEmpty())
                            <p class="text-center">Nu sunt șefi de departamente înregistrați.</p>
                        @endif
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($employees->where('role_id', 4)->isEmpty())
                            <p class="text-center">Nu sunt angajați înregistrați.</p>
                        @endif
                    </div>
                </div>
            </div>
