    ...
    <div id="content-wrapper border-0" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="mt-5 card shadow mb-4" id="formular-angajati">
                ...
                <!-- Grupează angajații pe baza departamentelor -->
                @php
                    $departments = $employees->groupBy('department_id');
                @endphp

                @foreach ($departments as $departmentId => $employeesInDepartment)
                    <div class="mb-4">
                        <h3>{{ $employeesInDepartment->first()->department->name }}</h3>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @foreach ($employeesInDepartment->where('role_id', 3) as $employee)
                                    <tr>
                                        <td>{{ $counter++ }}</td>
                                        <td>{{ $employee->name }}</td>
                        ...
                        @if ($employeesInDepartment->where('role_id', 3)->isEmpty())
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @php $counter = 1; @endphp
                                @foreach ($employeesInDepartment->where('role_id', 4) as $employee)
                                    <tr>
                                        <td>{{ $counter++ }}</td>
                                        <td>{{ $employee->name }}</td>
                                        <td>{{ $employee->phone }}</td>
                        ...
                        @if ($employeesInDepartment->where('role_id', 4)->isEmpty())
